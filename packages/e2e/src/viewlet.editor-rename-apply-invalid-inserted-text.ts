...
export const name = 'viewlet.editor-rename-apply-invalid-inserted-text'

export const test: Test = async ({ Locator, expect, Extension, FileSystem, Workspace, Main, Editor }) => {
  // arrange
  const extensionUri = import.meta.resolve('../fixtures/sample.rename-provider-apply-invalid-inserted-text')
